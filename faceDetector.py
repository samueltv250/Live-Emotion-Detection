...
frame_per_second = 30
emotionlLabels = {0: "Angry", 1: "Disgusted", 2: "Fearful", 3: "Happy", 4: "Neutral", 5: "Sad", 6: "Surprised"}




cascPath = "haarcascade_frontalface_default.xml"
model = "inputs/models/modelV1.h5"
    ...
    if frame is not None:
        ...
        if len(faces) != 0:
            for (x, y, w, h) in [faces[0]]:
                ...
                cv2.putText(frame, str(emotionlLabels[predicted_label]), (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 25*w/W, (0, 255, 0), 3)
...
def videoMaker(inputFile = None):
    ...
    if inputFile == None:
        ...
        while True:
            ...
            if frame is None:
                break
            drawFrame(frame) #grawing detected face and emotion over the frame
